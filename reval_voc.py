...
def parse_args():
    ...
    parser.add_argument('output_dir', nargs=1, default='results',help='results directory',type=str)
    parser.add_argument('--voc_dir', dest='voc_dir', default='data/Xview', type=str)
    parser.add_argument('--image_set', dest='image_set', default='test', type=str)
    parser.add_argument('--classes', dest='class_file', default='data/xviewyolo.names', type=str)
...
def do_python_eval(devkit_path, image_set, classes, output_dir = 'results'):
